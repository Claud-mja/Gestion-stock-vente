...
import { RavitaillementUpdateType } from './components/data'
...
@Component({
  selector: 'app-carte-credit-impl',
  standalone: true,
  imports: [
    OrderListComponent,
    BoughtComponent,
  ...
  templateUrl: './carte-credit-impl.component.html',
  styles: ``,
})
export class CarteCreditImplComponent {
